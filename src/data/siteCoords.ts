...
export const SITE_COORDS: Record<string, SiteCoord> = {
  ...
  "Pyrgos": { name: "Pyrgos", lat: 35.007, lon: 25.59, region: "crete" },
  ...
  "Apodoulou": { name: "Apodoulou", lat: 35.16, lon: 24.73, region: "crete" },
  ...
  "Zominthos": { name: "Zominthos", lat: 35.249, lon: 24.887, region: "crete" },
  ...
  "Skoteino Cave": { name: "Skoteino cave", lat: 35.305, lon: 25.297, region: "crete" },
  ...
  "Troullos": { name: "Troullos", lat: 35.27, lon: 25.16, region: "crete" },
